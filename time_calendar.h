...
#define SECS_CUTOVER_FOR_JULIAN (time_t)-62009539200ll//365 * 4 AD 0005-01-01 62135683200ll - (1460ll * 86400)
...
#define YEAR_OFFSET_FOR_JULIAN 5
#define YEAR_OFFSET_FOR_JULIAN_FIXING -8
#define YEAR_OFFSET_FOR_JULIAN_TYPO -45

#define SECS_OFFSET_FOR_GROGORIAN 24796800//(31+28+31+30+31+30+31+31+30+14) * 86400 count of days before 10-15 in 1582
#define SECS_OFFSET_FOR_JULIAN 0//AD 0005-01-01 00:00:00
#define SECS_OFFSET_FOR_JULIAN_FIXING 0
#define SECS_OFFSET_FOR_JULIAN_TYPO 0

#define SECS_OF_JD_BEFORE_1970 (time_t)210866760000LL//210866760000 - 43200 BC 4713-01-01 12:00:00 ((4713 * 365 + 4713 / 4 + 1 + 719163) * 86400ll - 43200)
