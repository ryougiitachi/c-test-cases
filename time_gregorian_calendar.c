...
const int DAYS_OF_100_YEAR_LOOP = (24ll * 366ll + 76ll * 365ll);
const int DAYS_OF_400_YEAR_LOOP = (24ll * 366ll + 76ll * 365ll) * 4ll + 1ll;
...
//		iNumDay =-iNumDay - 1;
	...
	if(isADFlag==-1 && ((itmyear-1) & 3)==0 && ((itmyear-1) % 100) != 0)
	{//BC nonleap year
		isLeapFlag = 1;
	}
